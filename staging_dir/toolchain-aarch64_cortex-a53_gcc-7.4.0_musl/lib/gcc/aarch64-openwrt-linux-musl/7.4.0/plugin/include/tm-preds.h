/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/zl/gl-image/gl-image/openwrt-19.07.git/build_dir/toolchain-aarch64_cortex-a53_gcc-7.4.0_musl/gcc-7.4.0/gcc/config/aarch64/aarch64.md'.  */
