...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/home/zl/gl-image/gl-image/openwrt-19.07.git/staging_dir/host/bin/grep -E"}
	: ${FGREP="/home/zl/gl-image/gl-image/openwrt-19.07.git/staging_dir/host/bin/grep -F"}
	: ${GREP="/home/zl/gl-image/gl-image/openwrt-19.07.git/staging_dir/host/bin/grep"}
	: ${SED="/home/zl/gl-image/gl-image/openwrt-19.07.git/staging_dir/host/bin/sed"}
fi
